...
text: ``,
html: ` <button id='btnLoja' class='btnList'>Ir para loja <i class="fa-solid fa-layer-group"></i></button> <button id='btnCompart' > <i id='Icompart' class="fa-solid fa-square-share-nodes"></i></button>`,
imageUrl: doc.URLIMG,
imageAlt: `${doc.Titulo}`,
background: '#ffffff',
